...
namespace universitysandy
{
   ...
   person p = new person();
        ...
        public void delfac(string fac) {
            ...
            openconnection();
            string query = "DELETE FROM faculty where facultyid= '"+fac+"'";
            cmd.CommandText = query;
            cmd.Connection = mycon;
            cmd.ExecuteNonQuery();
        ...
        public HashSet<string> selectcombo() {
            ...
            public void deldept(string fac)
            {
                ...
                openconnection();
                string query = "DELETE FROM department where departmentid= '"+fac+"'";
                cmd.CommandText = query;
     ...
     public HashSet<string> selectcombo2() {
